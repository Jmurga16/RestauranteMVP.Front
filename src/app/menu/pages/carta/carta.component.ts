  ...
  menuDemo: IMenu[] = [
    {
      ...
      descripcion: 'Menú especial con una selección de platos gourmet para una experiencia gastronómica completa.',
    },
    {
      id: 2,
      menuId: 2,
      nombre: 'Menú Ejecutivo',
      descripcion: 'Menú diario con opciones variadas para el almuerzo de trabajo, o la cena',
    ...
    },
    {
      ...
      descripcion: 'Menú con opciones adaptadas para niños, incluyendo platos pequeños y saludables.',
    },
  ];

  menuItems: IMenuPlato[] = [
    {
      menu: { id: 1, menuId: 1, nombre: 'Menú Infantil', descripcion: 'Menú especial para niños' },
      plato: {
        id: 1,
    ...
    {
      menu: { id: 2, menuId: 2, nombre: 'Menú Degustación', descripcion: 'Experiencia gourmet con varios tiempos' },
      plato: {
        id: 4,
    ...
    {
      menu: { id: 3, menuId: 3, nombre: 'Menú Ejecutivo', descripcion: 'Opciones rápidas y nutritivas para el día' },
      plato: {
        id: 6,
        nombre: 'Lomo Saltado',
